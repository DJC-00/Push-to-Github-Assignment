...
function recursiveBinarySearch(val, arr, front = 0, back = arr.length - 1) {
    ...
    console.log("Function")
    if (val <= arr[Math.floor(back/2) - 1]){
        console.log("left", front, back)
        return(recursiveBinarySearch(val, arr, front, Math.ceil(back - back/2)))
    }
    console.log("Function")
    if(val >= arr[Math.floor(back/2)]){
        console.log("right", front, back, arr[front], arr[back])
        return(recursiveBinarySearch(val, arr, Math.floor(front + ((back-front)/2)), back))
    }
    console.log("Function")
}
...
console.log(recursiveBinarySearch(11, arr, front = 0, back = arr.length - 1))